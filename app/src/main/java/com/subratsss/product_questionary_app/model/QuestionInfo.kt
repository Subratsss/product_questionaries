...
class QuestionInfo(
    ...
    override fun toString(): String {
        return "QuestionInfo(error_message='$error_message', mandatory=$mandatory, url='$url', placeholder='$placeholder', multi_option_flag=$multi_option_flag, question='$question', answers='$answers', image_flag=$image_flag, values=$values, multi_select_flag='$multi_select_flag', type='$type', question_id=$question_id)"
    }
}
